  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.7, delay: 2.35, ease: [0.25, 0.1, 0.25, 1] as const }}
      >
        {/* Strawberry */}
        ...
        <div className="relative flex-1 rounded-2xl overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-end px-3 py-2.5">
            ...
            <p className="font-serif text-lg font-bold text-white">Raspberry</p>
          </div>
        </div>
        ...
        <div className="relative flex-1 rounded-2xl overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-end px-3 py-2.5">
            <p className="font-sans text-[8px] tracking-[0.14em] uppercase text-white/55 mb-0.5">Coming Soon</p>
            <p className="font-serif text-lg font-bold text-white">Blueberry</p>
          </div>
        </div>
        ...
        <div className="shrink-0 flex items-center gap-3">
          ...
          <span className="font-sans text-[9px] tracking-[0.25em] uppercase text-muted">Preserve</span>
          <div className="flex-1 h-px bg-border" />
        </div>

        {/* Berry Preserve */}
        <div className="relative flex-1 rounded-2xl overflow-hidden">
          <Image src="/assets/real-farm2.jpg" alt="Berry Preserve" fill className="object-cover" sizes="100vw" />
          <div className="absolute inset-0 bg-[#5a3210]/70" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
          <div className="absolute inset-0 flex flex-col justify-end px-3 py-2.5">
            <p className="font-sans text-[8px] tracking-[0.14em] uppercase text-white/55 mb-0.5">Coming Soon</p>
            <p className="font-serif text-lg font-bold text-white">Berry Preserve</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <a
          ...
          className="flex items-center gap-2 bg-[#25D366]/10 border border-[#25D366]/25 rounded-xl px-3 py-2.5 hover:bg-[#25D366]/18 transition-colors cursor-pointer"
        >
          <svg className="w-5 h-5 text-[#25D366] shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <div className="min-w-0">
            <p className="font-sans text-[10px] font-semibold text-charcoal leading-tight">WhatsApp</p>
            <p className="font-sans text-[9px] text-muted truncate">+91 91765 40077</p>
          </div>
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 bg-[#E1306C]/10 border border-[#E1306C]/25 rounded-xl px-3 py-2.5 hover:bg-[#E1306C]/18 transition-colors cursor-pointer"
        >
          <svg className="w-5 h-5 text-[#E1306C] shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <div className="min-w-0">
            <p className="font-sans text-[10px] font-semibold text-charcoal leading-tight">Instagram</p>
            <p className="font-sans text-[9px] text-muted truncate">@theberrypatch.in</p>
          </div>
        </a>
      </motion.div>
    </section>
